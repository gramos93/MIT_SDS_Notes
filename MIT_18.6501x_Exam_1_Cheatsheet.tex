...
\subsubsection{All the matrices/vectors}
...
\left[
\begin{array}{ccc}
    \frac{\partial^2 g_1(\theta)}{\partial \theta_1^2}& &\frac{\partial^2 g_k(\theta)}{\partial \theta_1^2}\\
    \vdots& \vdots & \vdots\\
    \frac{\partial^2 g_1(\theta)}{\partial \theta_d^2}& &\frac{\partial^2 g_k(\theta)}{\partial \theta_d^2}\\
\end{array}
\right]
$$
