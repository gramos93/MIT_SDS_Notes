...
Instead, we compute que quantiles for the test statistic: $$T_n = \underset{t\in \mathbb{R}}{sup} \: \sqrt{n}|F_n(t) - \Phi_{\widehat{\mu}, \widehat{\sigma^2}}(t)|$$
...
The Jeffreys' prior satisfies a \emph{representation invariance principal}.If $\eta = \phi(\theta)$ in an invertible function then the PDF 
